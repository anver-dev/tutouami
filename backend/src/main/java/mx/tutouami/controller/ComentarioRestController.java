...
import mx.tutouami.service.impl.ServicioComentario;
...
public class ComentarioRestController {
	...
	public ResponseEntity<?> create(@RequestBody @Valid CommentDTO nuevoComentario,
			@PathVariable("idAlumno") Long idAlumno, @PathVariable("idAsesoria") Long idAsesoria) {
		try {
			CommentDTO comentarioDto = servicioComentario.agregarComentario(idAlumno, idAsesoria, nuevoComentario);
	...
	public ResponseEntity<List<CommentDTO>> retrieveAll() {

		log.info("Se consulta endpoint /comentarios");
		List<CommentDTO> comentarios = servicioComentario.recuperaComentarios();
	...
	public ResponseEntity<?> delete(@PathVariable("idAlumno") @Valid Long idAlumno,
		...
		try {
			CommentDTO comentario = servicioComentario.retrieve(idComentario);
			if (comentario != null) {
	...
	public ResponseEntity<CommentDTO> update(@PathVariable("idAlumno") @Valid Long idAlumno,
			@PathVariable("idAsesoria") @Valid Long idAsesoria, @PathVariable("idComentario") @Valid Long idComentario,
			@RequestBody @Valid CommentDTO comentarioDto) {
		...
		try {
			...
			CommentDTO comentario = servicioComentario.actualizar(idAlumno, idComentario, idAsesoria, comentarioDto);
